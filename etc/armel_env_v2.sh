...
# set mount points for the sdcard -> aria
export ARIA_MEDIA_KERNEL=/mnt/aria_kernel
export ARIA_MEDIA_ROOTFS=/mnt/aria_rootfs
export ARIA_MEDIA_HOME=/mnt/aria_home
